                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-sm-6">
                        <div class="all__product--link text-right mb-30">
                            <a class="all-link" href="#">Lihat Selengkapnya ...<span class="lnr lnr-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="product__single">
                                <div class="product__box">
                                    ...
                                    <div class="product__content--top">
                                        <span class="cate-name" style="text-transform:none !important">Di upload oleh <b>Admin</b> 3 hari yang lalu</span>
