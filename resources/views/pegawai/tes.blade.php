...
<!-- Mirrored from themepure.net/template/shupmax/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 09:44:18 GMT -->
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="nav--top__dropdown position-relative"><a class="nav--top__link lang--top__link dove__gray-color text-capitalize position-relative" href="#">English & Dollar<span class="lnr lnr-chevron-down"></span></a>
                                        <ul class="dropdown-show">
                                            ...
                                            <li><a class="dove__gray-color text-capitalize" href="#"><span class="lang">Bangladesh</span><span class="currency">TAKA</span></a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <div class="cart--header__middle cart--header__three">
                                <div class="cart--header__list">
                                    <ul class="list-inline">
                                        ...
                                        <li><a class="mini__cart--link" href="#"><i class="fal fa-bags-shopping"><span class="cart__count">3</span></i><span class="cart__amount">$
                                                    3550</span></a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="main-menu">
                            <nav id="mobile-menu">
                                <ul>
                                    ...
                                    <li>
                                        <a href="widgets.html">About Us</a>
                                    </li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="about-single mb-30">
                            <div class="about-img">
                                <img src="img/offer/about__thumb__20.jpg" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="about-single mb-30">
                            <div class="about-img">
                                <img src="img/offer/about__thumb__21.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="about-text">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="about-single mb-30">
                            <div class="about-img">
                                <img src="img/offer/about__thumb__22.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="about-text">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="about-single mb-30">
                            <div class="about-img">
                                <img src="img/offer/about__thumb__23.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="about-text">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-8 mb-30">
                        <div class="footer-widget">
                            ...
                            <div class="contacts-address--footer">
                                <p>502 New Design Str, Melbourne, Australia <a href="https://themepure.net/cdn-cgi/l/email-protection#83e0ecedf7e2e0f7c3eee2f1f7e5f6f1faade0ec"><span class="__cf_email__" data-cfemail="a7c4c8c9d3c6c4d3e7cac6d5d3c1d2d5de89c4c8">[email&#160;protected]</span></a></p>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from themepure.net/template/shupmax/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Feb 2022 09:44:19 GMT -->
